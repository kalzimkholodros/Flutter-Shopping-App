                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/sports.jpg'), // Örnek ürün görseli
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                        ...
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                // Satın alma işlemi
                                print('Sports Item ${index + 1} bought!');
                              },
                            ...
                            Row(
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    // Like işlemi
                                    print('Sports Item ${index + 1} liked!');
                                  },
                                ),
                                IconButton(
                                  ...
                                  onPressed: () {
                                    // Dislike işlemi
                                    print('Sports Item ${index + 1} disliked!');
                                  },
                                ),
                              ],
                            ),
