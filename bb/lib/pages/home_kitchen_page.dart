                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/home_kitchen.jpg'), // Örnek ürün görseli
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                        ...
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                // Satın alma işlemi
                                print('Home Item ${index + 1} bought!');
                              },
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    // Dislike işlemi
                                    print('Home Item ${index + 1} disliked!');
                                  },
                                ),
                              ],
                            ),
